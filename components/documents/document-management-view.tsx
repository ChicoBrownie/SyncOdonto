...
export function DocumentManagementView() {
  ...
  return <div className="space-y-5"><div><h1 className="text-2xl font-bold">Documentos sustentáveis</h1><p className="text-sm text-muted-foreground">Personalize os documentos digitais usados pela sua clínica e acompanhe o impacto ambiental de evitar a impressão.</p></div>
